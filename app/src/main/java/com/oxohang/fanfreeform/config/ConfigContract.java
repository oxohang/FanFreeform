...
public final class ConfigContract {
    ...
    public static final int DEFAULT_LANDSCAPE_WIDTH_PERCENT = 48;
    public static final int DEFAULT_LANDSCAPE_HEIGHT_PERCENT = 78;
    public static final int DEFAULT_LANDSCAPE_POSITION_X = 50;
    ...
    public static final int DEFAULT_OUTSIDE_TAP_WINDOW_MS = 240;
    ...
    public static final boolean DEFAULT_HONEYCOMB_ENABLED = false;
    public static final int DEFAULT_HONEYCOMB_MODE = HONEYCOMB_MODE_BROWSE;
    public static final int DEFAULT_HONEYCOMB_TRIGGER_DP = 170;
    public static final int MIN_HONEYCOMB_TRIGGER_DP = 120;
    public static final int MAX_HONEYCOMB_TRIGGER_DP = 240;
    public static final int DEFAULT_HONEYCOMB_ICON_SIZE_DP = 52;
    public static final int MIN_HONEYCOMB_ICON_SIZE_DP = 20;
    public static final int MAX_HONEYCOMB_ICON_SIZE_DP = 100;
    public static final int DEFAULT_HONEYCOMB_SPACING_DP = 60;
    ...
    public static final int DEFAULT_FAN_MAX_TARGETS = 8;
    public static final int MIN_FAN_MAX_TARGETS = 3;
    public static final int MAX_FAN_MAX_TARGETS = 24;
    public static final int DEFAULT_HONEYCOMB_MAX_TARGETS = 36;
    ...
    public static final int DEFAULT_SIDE_MAX_TARGETS = 12;
    ...
    public static final boolean DEFAULT_HONEYCOMB_FOLLOW_FINGER = true;
    ...
    public static final int DEFAULT_HONEYCOMB_FIXED_Y_PERCENT = 58;
    ...
    public static final int DEFAULT_HONEYCOMB_RETREAT_DP = 64;
    public static final int MIN_HONEYCOMB_RETREAT_DP = 20;
    public static final int MAX_HONEYCOMB_RETREAT_DP = 120;
    public static final int DEFAULT_HONEYCOMB_DISC_SIZE_PERCENT = 88;
